...
subroutine task_exchange(f_local,dimx1,dimx2,dimy1,dimy2,dimz,i_1, i_2, j_1, j_2, id)
...
bufflen = max(nx,ny)*(3+NADVS)*nz
allocate ( buff_send(bufflen)      )
allocate ( buff_recv(bufflen,8)      )
