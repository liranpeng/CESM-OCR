module physpkg
  ...
  use spmd_utils,       only: masterproc !bloss , MPI_COMM_WORLD, MPI_BCast, MPI_Integer !bloss: add MPI_COMM_WORLD
...
!=======================================================================
  ...
  subroutine phys_register
    ...
    integer  :: nmodes
    integer :: dummy(1), ierr !bloss MPI Vars
    !-----------------------------------------------------------------------
