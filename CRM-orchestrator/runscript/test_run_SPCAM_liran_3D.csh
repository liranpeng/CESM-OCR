...
@ CRM_pcount       = $spcam_orctotal * $spcam_subx * $spcam_subx
@ NPNN = $pcount +  $CRM_pcount
@ NNODE0 = $NPNN / 50 + 1
@ NNODE  = 3
if (${NNODE0} > 3) then
...
setenv CASE        SPdev_liran2_1mom_crmnx${crm_nx}_crmny${crm_ny}_subx${spcam_subx}_suby${spcam_suby}_${spcam_orctotal}orc_${NNODE}nodes_${queue}
## ====================================================================
