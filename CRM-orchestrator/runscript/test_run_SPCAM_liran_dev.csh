...
set spcam_subx     = SBX
set spcam_suby     = 1
set spcam_orctotal = 6
@ CRM_pcount       = $spcam_orctotal * $spcam_subx
@ NPNN = $pcount +  $CRM_pcount 
@ NNODE = $NPNN / 50 + 1
setenv CASE        Timing_crmnx${crm_nx}_crmny${crm_ny}_subx${spcam_subx}_suby${spcam_suby}_${spcam_orctotal}orc_${NNODE}nodes_${NPNN}_${queue}
## ====================================================================
