...
sed -e "s/SUBXX/${SUBX}/g; s/NNNX/${NX}/g" test_run_SPCAM_liran_auto_dev_2D_debug.csh > run_2Ddev_debug_${SUBX}_${NX}.csh
chmod 700 run_2Ddev_debug_${SUBX}_${NX}.csh
./run_2Ddev_debug_${SUBX}_${NX}.csh
done
done
