...
@ NNODE = $NPNN / $NPNX + 1
setenv CASE       scalling_${UNAME}_nodebug_GCMgrid_${CASERES}_GCMRes_${CASERES}_GCMTask${pcount}_crmnx${crm_nx_in}_crmny${crm_ny_in}_subx${spcam_subx_in}_suby${spcam_suby_in}_${spcam_orctotal_in}orc_${NNODE}nodes_${queue}
## ====================================================================
...
setenv DATADIR   $SCRATCH/inputdata # pritch, link to bloss' downloaded input data.
...
sed -e "s/NPN/$NPNX/g; s/NNODE/$NNODE/g; s/CASE_FOLDER/$CASE/g" $HOME/repositories/CESM-OCR/CRM-orchestrator/runscript/CRM/case.run.sample > $CASEROOT/.case.run
