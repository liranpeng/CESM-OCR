...
### GRID OPTIONS <Liran>
set crm_nx_in         = NNNX         # <<< change this one!
set crm_ny_in         = NNNX
set crm_dx_in         = 4000
set crm_dt_in         = 1
set crm_nz_in         = 24
set spcam_subx_in     = SUBXXXX
set spcam_suby_in     = SUBXXXX
...
cd  $CASEROOT
sed -e "s/SUBX/$spcam_subx_in/g; s/SUBY/$spcam_suby_in/g; s/ORCT/$spcam_orctotal_in/g;" $HOME/repositories/CESM-OCR/CRM-orchestrator/runscript/CRM/crmdims.sample > $HOME/repositories/CESM-OCR/components/cam/src/physics/spcam/crmdims.F90 
