...
set spcam_subx_in     = 2
set spcam_suby_in     = 1
set spcam_orctotal_in = 300
set NPNX              = 50
@ CRM_pcount       = $spcam_orctotal_in * $spcam_subx_in * $spcam_suby_in
@ NPNN = $pcount +  $CRM_pcount
@ NNODE = $NPNN / $NPNX + 1
setenv CASE       scalling_Fmode_nodebug_${YOURNAME}_crmnx${crm_nx_in}_crmny${crm_ny_in}_subx${spcam_subx_in}_suby${spcam_suby_in}_${spcam_orctotal_in}orc_${NNODE}nodes_${queue}
## ====================================================================
...
sed -e "s/NPN/$NPNX/g; s/YNAME/$YOURNAME/g; s/NNODE/$NNODE/g; s/CASE_FOLDER/$CASE/g" $HOME/repositories/CESM-OCR/CRM-orchestrator/runscript/CRM/case.run.sample > $CASEROOT/.case.run
...
cp $SCRATCH/tg863871/CESM2_case/$CASE/$CASE/bld/atm/obj/crmx_mpi.o .
